...
- New: Added setup and upgrade instructions

## 5.0.1 - 2024-05-07
- Update: Changed author and contact settings

## 5.0.0 - 2024-05-07
> {warning} You are now on the diff. Kommunikation AG fork of this repository
- New: Craft CMS 5 support
